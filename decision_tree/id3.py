...
def createDataSet():
    ...
    labels=['age','income','student','credit']
...
def chooseBestFeature(dataSet):
    ...
    for i in range(featureCount):
        ...
        print("当前划分属性信息熵:", divide_feature_Ent, "当前划分依据:", labels[i], "当前划分属性信息增益：", infoGain)
...
if __name__ == '__main__':
    ...
    print(tree)
    print("DivisionClass:",classify(tree, labels, ["<30", "low","yes","fair"]))
